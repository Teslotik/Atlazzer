...
class AtlazzerMaterialPanel(Panel):
    ...
    def draw(self, context:Context):
        ...
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_albedo')
        row.prop(context.scene.material_props, 'albedo_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_albedo_alpha')
        row.prop(context.scene.material_props, 'albedo_alpha_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_roughness')
        row.prop(context.scene.material_props, 'roughness_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_smooth')
        row.prop(context.scene.material_props, 'smooth_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_metal')
        row.prop(context.scene.material_props, 'metal_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_metal_roughness')
        row.prop(context.scene.material_props, 'metal_roughness_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_metal_smooth')
        row.prop(context.scene.material_props, 'metal_smooth_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_normal')
        row.prop(context.scene.material_props, 'normal_suffix', text = 'Suffix')
        row = layout.row()
        row.prop(context.scene.material_props, 'bake_emission')
        row.prop(context.scene.material_props, 'emission_suffix', text = 'Suffix')